...
export default class FogMap extends Component {
  ...
  clearCanvas = () => {
    ...
    this
      .context
      .clearRect(0, 0, this.cvs.width, this.cvs.height);
    this.context.fillStyle = FOGCOLOR;
    this
      .context
      .fillRect(0, 0, this.cvs.width, this.cvs.height);
  ...
  initGPS = () => {
    ...
    const successHandler = (pos) => {
      ...
      this
        .map
        .panTo(new window['AMap'].Lnglat(longitude, latitude));
      this
        .steps
    ...
    window['navigator']
      .geolocation
      .watchPosition(successHandler, errorHandler);
    window['navigator']
      .geolocation
  ...
  initMap = () => {
    ...
    this
      .map
      .setFeatures(["bg", "building", "point", "roard"]);
  ...
  mapEvents = () => ({
    ...
    click: e => {
      ...
      this
        .steps
        .push({longitude: lng, latitude: lat});
      this
        .fogLayer
        .render();
    }
